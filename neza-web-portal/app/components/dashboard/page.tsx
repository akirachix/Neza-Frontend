...
function Dashboard() {
  return (
    <div className='flex '>
      ...
      <div className= "flex w-[653px] h-[57px] rounded-[10px] mt-10 border-2 border-black border-opacity-3" >
     <p className='mt-5 ml-5 text-green-500 font-2xl'><FaSearch /></p> 
        <input
          type="email"
          id="organizationEmail"
          name="organizationEmail"
          placeholder='Search by location'   
          className='text-[18px] ml-5 border-none'     
          required
        />
      </div>
      <div className="mt-1">
