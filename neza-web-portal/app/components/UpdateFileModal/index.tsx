  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center">
        <div className="bg-green-400 p-5 shadow-md rounded-md border-gray-500  mr-10 w-1/3 h-1/2 flex flex-col justify-center items-center">
          <h2 className="font-bold text-2xl">Update File</h2>
          <br />
          <p>
            <span className="font-bold text-1xl">Original Name:</span> {fileData.name}
          </p>
          <br />
          <p>
            <span className="font-bold text-1xl">Uploaded at: </span>
            {fileData.timestamp}
          </p>
          <br />
          <label htmlFor="updated-name">
            <span className="font-bold text-1xl">Updated Name:</span>
          </label>
          <input
          ...
          <br />
          <br />
          <button className="bg-white text-black px-4 py-2 rounded-md" onClick={handleUpdate}>
            Update
          </button>
          <br />
